...
// ============== CONFIGURACIÓN WiFi ==============
const char* ssid = "Galaxy";           // ⚠️ CAMBIAR
const char* password = "12345678";    // ⚠️ CAMBIAR

// ============== CONFIGURACIÓN MQTT ==============
const char* mqtt_server = "192.168.4.159";  // ⚠️ IP de tu broker Mosquitto
...
uint8_t peerMac[6] = {0x4C, 0xC3, 0x82, 0x0C, 0x83, 0x7C}; // ⚠️ MAC del ESP-1
